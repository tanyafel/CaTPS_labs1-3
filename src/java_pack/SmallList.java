...
public class SmallList implements List_action
{
    ...
    public SmallListNode head; // первый элемент списка
    public SmallListNode tail; // последний элемент списка

    public class SmallListNode
    {
        private UserType item;        // данные узла списка
        public SmallListNode next; // указатель на след. узел

        private SmallListNode(UserType _item, SmallListNode _next)
        {
            item = _item;
            next = _next;
        }
        ...
        public void set_next(SmallListNode _next) {
            next = _next;
        }
    ...
    public SmallList(ArrayList<UserType> arr)
    {
        for (UserType cur: arr) {
            push(cur);
        }
    }

    public void set_head(SmallListNode node)
    {
        head = node;
    }
    ...
    public void push_node(SmallListNode node) {
    ...
    @Override
    public ArrayList<UserType> to_array()
    {
